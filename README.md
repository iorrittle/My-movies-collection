...
# データベース設計
[![Image from Gyazo](https://i.gyazo.com/8297837652320f134eb59e7d740bea32.png)](https://gyazo.com/8297837652320f134eb59e7d740bea32)

#  開発環境    
Ruby/Ruby on Rails/MySQL/Github/AWS/Visual Studio Code/jQuery/JavaScript  

# 工夫した点
・「movie chat ページ」は、投稿機能とは紐づいておらず、アプリケーションの中で特有の機能であるため  
ビューを全く異なる印象になるよう差別化した。  
